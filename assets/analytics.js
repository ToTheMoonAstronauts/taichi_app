/* Tai Motion APP — first-party engagement analytics (events only, NO session replay).
 * Writes to the isolated log-event function (funnel_events table) + PostHog (recording off).
